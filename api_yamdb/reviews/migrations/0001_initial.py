    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(), api.validators.validate_username], verbose_name='Никнейм')),
                ...
                ('role', models.CharField(blank=True, choices=[('user', 'user'), ('admin', 'admin'), ('moderator', 'moderator')], default='user', max_length=255, verbose_name='Группа пользователей')),
                ('confirmation_code', models.CharField(blank=True, default='***', max_length=255, null=True, verbose_name='код подтверждения')),
